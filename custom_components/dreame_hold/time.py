...
SCHEDULED_DRYING_TIME_DESCRIPTION = TimeEntityDescription(
    ...
    # "1" sort prefix, following "0 Enabled" in switch.py and preceding
    # "2"-"8" on the weekday switches - see DreameHoldWeekdaySwitch's
    # docstring for why plain alphabetical names don't work on Home
    # Assistant's device page (confirmed live: this entity, previously
    # named "Scheduled drying: Start time" with no digit, sorted right in
    # the middle of the weekday list instead of right after Enabled).
    name="Scheduled drying: 1 Start time",
